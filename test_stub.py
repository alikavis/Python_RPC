...
class test_stub:
    ...
    def func1(self, a, b, id):
        ...
        # GENERATE TEMPLATE TO EMBED USER DEFINITION OF PARAMETER NAMES AND TYPES
        ...
        # GENERATE TEMPLATE FOR USER DEFINED PARAMETERS
        param_list = [id, a, b]
        ...
        while count < self.retry_count:
            count += 1
            # send the function naem and its parameters to remote server
            try:
        ...
        if json_obj['status'] == 'OK':
            ...
            # return
            if isinstance(ret_param_list[0], numbers.Number) and isinstance(ret_param_list[1], str):
